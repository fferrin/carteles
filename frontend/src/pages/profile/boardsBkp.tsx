              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                {boards.map(board => (
                  ...
                  >
                    ...
                    >{board.name}</th>
                    <td className="px-4 py-3">{board.category}</td>
                    <td className="px-4 py-3">{board.brand}</td>
                    <td className="px-4 py-3">{board.description}</td>
                    <td className="px-4 py-3">{board.price}</td>
