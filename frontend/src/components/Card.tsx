  ...
  return (
    <div
      ...
      <div className="p-5">
        ...
        <p className="mb-3 text-sm font-light text-gray-400 dark:text-gray-400">
          {board.address}
        </p>
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
          {board.price} {board.currency}/mes
        </p>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
          Creado: {relativeTimeFormat(new Date(board.date_creation))}
        </p>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
          Última edición: {relativeTimeFormat(new Date(board.date_update))}
        </p>
        <a href="#"
