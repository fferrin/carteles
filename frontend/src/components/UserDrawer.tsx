...
export default function lngDrawer() {
  const items = [
    ["Mis Datos", routes.profile],
    ["Mis Carteles", routes.userBoards],
    ["Mi Suscripción", routes.userSubscription],
  ]
  ...
  return <aside className="top-0 left-0 w-64 h-full" aria-label="Sidenav">
    <div
    ...
    <div
      ...
      <Link href="#" data-tooltip-target="tooltip-settings"
          ...
          <li>
            <Link href="#"
              ...
              <div className="inline-flex items-center">
                <svg aria-hidden="true" className="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
